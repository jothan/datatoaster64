...
impl From<Stat> for fuser::FileAttr {
    fn from(s: Stat) -> Self {
        fuser::FileAttr {
            ...
            atime: SystemTime::UNIX_EPOCH + s.0.atime,
            mtime: SystemTime::UNIX_EPOCH + s.0.mtime,
            ctime: SystemTime::UNIX_EPOCH + s.0.ctime,
            crtime: SystemTime::UNIX_EPOCH + s.0.crtime,
            rdev: 0,
            flags: 0,
        }
    }
